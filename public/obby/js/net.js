// WebSocket client + interpolation buffer for Obby (same pattern as the other
// ClaudeBox games, pointed at /obby-ws).
...
export class Net {
  ...
  connect() {
    ...
    this.ws = new WebSocket(`${proto}://${location.host}/obby-ws`);
